  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-5 sm:px-8 py-14 grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div>
          <h4 className={`font-semibold mb-4 ${dark ? "text-white" : "text-slate-900"}`}>Quick Links</h4>
          <ul className={`space-y-2 text-sm ${dark ? "text-slate-400" : "text-slate-500"}`}>
            {FOOTER_LINKS.map((l) => (
              <li key={l}>
                <button onClick={() => scrollTo(l)} className="hover:text-blue-500 transition-colors">
                  {l}
                </button>
              </li>
            ))}
        ...
        <div>
          <h4 className={`font-semibold mb-4 ${dark ? "text-white" : "text-slate-900"}`}>
            Connect With Me
          </h4>
          <ul className={`space-y-2 text-sm ${dark ? "text-slate-400" : "text-slate-500"}`}>
            ...
            <li className="flex items-center gap-2">
              <SiGithub className="w-4 h-4" size={16} /> GitHub
            </li>
            <li className="flex items-center gap-2">
        ...
        <div>
          <h4 className={`font-semibold mb-4 ${dark ? "text-white" : "text-slate-900"}`}>Newsletter</h4>
          ...
          {subscribed && <p className="text-emerald-500 text-xs mt-2">Thanks for subscribing!</p>}
        </div>
      </div>
      <div
