  ...
  return (
    <header
      ...
      <div className='max-w-7xl mx-auto px-5 sm:px-8 h-16 flex items-center justify-between'>
        ...
        <div className='w-32 h-32 rounded-md flex items-center justify-center text-white font-bold text-sm'>
          <img src={navLogo}></img>
        </div>
        {/* <span
        ...
        <button
          ...
          {menuOpen ? (
            <X
              className={dark ? "text-white w-6 h-6" : "text-slate-900 w-6 h-6"}
            />
          ) : (
            <Menu
              className={dark ? "text-white w-6 h-6" : "text-slate-900 w-6 h-6"}
